...
import java.text.*;
public class StudPersonalData {
  JFrame f = new JFrame("Student Personal Details");
  JPanel jp1,jp3,jpl1,jpl2,jpl3;
  ...
  StudPersonalData() {
	...
	String user = "SYSTEM";
	String pass = "hari";
	String qr="SELECT * FROM STUDM"+ChooseStan.lst;
	qry=qr;
   try {
    ...
    rf = new JTextField(Integer.toString(roll),0);
    Border empty = BorderFactory.createEmptyBorder(0,0,0,165);
    ...
    jpl1.add(d);
    JFormattedTextField df = new JFormattedTextField(new SimpleDateFormat("dd/MM/yyyy"));
    ...
    jpl1.add(st);
    stf = new JTextField(ChooseStan.lst,0);
